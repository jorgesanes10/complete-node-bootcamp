...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      type: Number,
      default: 4.5,
      min: [1, 'The rating must be greater or equal to than 1'],
      max: [5, 'The rating must be less or equal to than 5'],
    },
    ratingsQuantity: {
      type: Number,
      default: 0,
    ...
    priceDiscount: {
      ...
      validate: {
        ...
        message:
          'The discount price ({VALUE}) should be lower than the regular price',
      },
    },
    summary: {
      type: String,
